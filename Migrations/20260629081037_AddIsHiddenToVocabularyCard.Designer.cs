...
namespace LexiLearn.Migrations
{
    ...
    [Migration("20260629081037_AddIsHiddenToVocabularyCard")]
    partial class AddIsHiddenToVocabularyCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LexiLearn.Models.AiConversation", b =>
                {
            ...
            modelBuilder.Entity("LexiLearn.Models.AiMessage", b =>
                {
                    ...
                    b.HasIndex("AiConversationId", "CreatedAt");

                    b.ToTable("AiMessages");
                });

            modelBuilder.Entity("LexiLearn.Models.CardReview", b =>
                {
                    b.Property<int>("CardReviewId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CardReviewId"));
            ...
            modelBuilder.Entity("LexiLearn.Models.AiMessage", b =>
                {
                    b.HasOne("LexiLearn.Models.AiConversation", "Conversation")
                        .WithMany("Messages")
